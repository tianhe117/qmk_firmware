...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
    [_BASE_LAYER] = LAYOUT(
        ...
        BA_LCTL, BA_LGUI, BA_LALT,                   BA_SPC,                    BA_RGUI, BA_RALT, BA_LCTL
    ),
    ...
    [_DEFAULT_LAYER] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                   KC_SPACE,                  KC_RGUI, KC_RALT, KC_LCTL
    ),
    ...
    [_SPC_LAYER] = LAYOUT(
        ...
        SP_LCTL, SP_LGUI, SP_LALT,                   SP_SPC,                    SP_RGUI, SP_RALT, SP_LCTL
    ),
    ...
    [_FN_LAYER] = LAYOUT(
        ...
        FN_LCTL, FN_LGUI, FN_LALT,                   FN_SPC,                    FN_RGUI, FN_RALT, FN_LCTL
    ),
    ...
    [_FN1] = LAYOUT(
        ...
        F1_LCTL, F1_LGUI, F1_LALT,                   F1_SPC,                    F1_RGUI, F1_RALT, F1_LCTL
    ),
    [5] = LAYOUT(
